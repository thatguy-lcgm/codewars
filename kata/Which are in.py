...
array r in lexicographical order of the strings of a1 which
...
Notes:
Arrays are written in "general" notation. See "Your Test
Cases" for examples in your language.
